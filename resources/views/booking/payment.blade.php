...
<section id="Content" class="w-full max-w-[1280px] mx-auto px-[52px] mt-16 mb-[100px]">
    <div class="flex flex-col gap-16">
        ...
        <main class="flex gap-8">
            ...
            <form id="Form" methot="POST" enctype="multipart/form-data" action="{{route('front.payment_store')}}"
                            ...
                            <label class="flex flex-col gap-4">
                                ...
                                <div
                                    ...
                                    <img src="assets/images/icons/bank.svg"
                                        ...
                                        alt="icon">
                                    <img src="assets/images/icons/bank-black.svg"
                            ...
                            <label class="flex flex-col gap-4">
                                ...
                                <div
                                    ...
                                    <img src="assets/images/icons/profile-circle.svg"
                                        class="w-6 h-6 flex shrink-0 group-focus-within:hidden group-has-[:valid]:hidden"
                                        alt="icon">
                                    <img src="assets/images/icons/profile-circle-black.svg"
                                        class="w-6 h-6 shrink-0 hidden group-focus-within:flex group-has-[:valid]:flex"
                                        alt="icon">
